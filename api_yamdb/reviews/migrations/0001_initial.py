# Generated by Django 2.2.16 on 2021-10-17 11:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(blank=True, null=True, related_name='titles1', to='reviews.Genre')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('score', models.IntegerField(blank=True, help_text='Оценка может быть от 0 до 10', null=True, validators=[reviews.validations.validate_score], verbose_name='Оценка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='reviews.Review', verbose_name='ID отзыва')),
            ],
            options={
